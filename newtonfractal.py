...
a = complex(1, 0)
roots = [complex(1, 0), complex(-1/2, math.sqrt(3)/2), complex(-1/2, -math.sqrt(3)/2)]
INF = 1e9
DX = 1e-9
...
def main():
    ...
    image = calculateImgPlot(radius=radius, pixels=pixels, numIterations=numIterations)
